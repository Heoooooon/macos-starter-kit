...
> ```
> apt·dnf·pacman·zypper를 자동 감지합니다 (glibc 배포판; Alpine/musl 미지원). (한국어 전체 안내: [README.ko](../README.ko.md#-windows--linux-도-됩니다))
...
no musl builds). Verified end-to-end on Ubuntu, Fedora, openSUSE and Arch.
